...
const redesigns = [
    // { key: 'twitter', name: 'Twitter / X', Icon: FaXTwitter },
...
export default function V2Redesigns() {
    ...
    // 3 items ~ 70% translation to reveal all on mobile, 60% on desktop
    const x = useTransform(scrollYProgress, [0, 1], ["0%", isMobile ? "-160%" : "-25%"])
                            ...
                            return (
                                ...
                                >
                                    <div className="v2-project-card-inner">
                                        ...
                                        <h3 className="v2-project-name" style={{ marginTop: "2rem" }}>
                                            {rd.name}
                                        </h3>
