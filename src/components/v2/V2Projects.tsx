...
export default function V2Projects() {
    ...
    const handleMobileScroll = () => {
        ...
        const cardWidth = el.scrollWidth / apps.length
        const idx = Math.round(el.scrollLeft / cardWidth)
        setMobileActiveIdx(Math.max(0, Math.min(idx, apps.length - 1)))
    }
    ...
    const appName = (key: string) =>
        key === 'nos2' ? 'Nós 2' : key.charAt(0).toUpperCase() + key.slice(1).replace(/([a-z])([A-Z])/g, '$1 $2')

    const renderCardContent = (app: AppProject) => (
        <div className="v2-project-card-inner">
            ...
            <h3 className="v2-project-name">{appName(app.key)}</h3>
            ...
            <button
                ...
                onClick={() => { setSelectedProject(app); setCurrentScreenshot(0) }}
            >
                {t('apps.learnMore')}
            </button>
                    ...
                    >
                        ...
                        <div className="v2-modal-header">
                            ...
                            <div className="v2-modal-info">
                                <h2 className="v2-project-name">{appName(selectedProject.key)}</h2>
                            ...
                            <div className="v2-modal-carousel-container">
                                <div className="v2-modal-carousel" style={{ width: '65%', margin: '0 auto' }}>
                                    ...
                                    <AnimatePresence mode="wait">
                                        ...
                                        >
                                            <img src={selectedProject.screenshots?.[currentScreenshot]} alt={`Screenshot ${currentScreenshot + 1}`} />
                                        </motion.div>
                                    </AnimatePresence>
                                    <button
    ...
    if (isMobile) {
        return (
            <>
                <div className="v2-mobile-section-wrapper" style={{ background: 'var(--v2-bg-panel)', borderBottom: '1px solid var(--v2-gold-dim)' }}>
                    ...
                    >
                        {apps.map((app) => (
                            <div key={app.key} className="v2-project-card v2-mobile-card">
