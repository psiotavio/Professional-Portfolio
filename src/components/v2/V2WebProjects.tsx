...
export default function V2WebProjects() {
    ...
    const x = useTransform(scrollYProgress, [0, 1], ["0%", isMobile ? "-320%" : "-55%"])
                ...
                >
                    ...
                    >
                        {projects.map((project) => {
                            return (
                                <div key={project.key} className="v2-project-card v2-web-project-card" style={{ flexShrink: 0, width: isMobile ? '100%' : '450px', maxWidth: '450px' }}>
                                    <div className="v2-project-card-inner">
                                        ...
                                        <h3 className="v2-project-name">
                                            {project.key === 'watchfolio' ? 'WatchFolio Web' : project.key.charAt(0).toUpperCase() + project.key.slice(1)}
                                        </h3>
                                ...
                                <div className="v2-modal-info">
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                                        <h2 className="v2-project-name" style={{ fontSize: '2.5rem' }}>
                                            {selectedProject.key === 'watchfolio' ? 'WatchFolio Web' : selectedProject.key.charAt(0).toUpperCase() + selectedProject.key.slice(1)}
                                        </h2>
